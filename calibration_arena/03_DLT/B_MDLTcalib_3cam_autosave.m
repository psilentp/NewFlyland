% File used to test different routines for 3D calibration of cameras.
clear;
close all
data1=[];

[file, pname] = uigetfile('*.mat','Calibration image data file selection','DLT_coeff.mat');
cd(pname);
load(file);
...
elseif Meth == 2
    [dlt1, k1]=mdlt1mod_2(Pts,Cam1);
    [dlt2, k2]=mdlt1mod_2(Pts,Cam2);
    [dlt3, k3]=mdlt1mod_2(Pts,Cam3);
    B1=dlt1(k1,:);
    B2=dlt2(k2,:);
    B3=dlt3(k3,:);
    [CamCoef(:,1)]=B1(:,:)';
...
save( ['M',file], 'DLT','F','L', 'L_1', 'L_2', 'L_3');
