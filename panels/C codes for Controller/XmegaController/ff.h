/*---------------------------------------------------------------------------/
/  FatFs - FAT file system module include file  R0.07b       (C)ChaN, 2009
/----------------------------------------------------------------------------/
...
#define	_USE_LFN	0
#define	_MAX_LFN	64		/* Maximum LFN length to handle (max:255) */
...
#define	_SYNC_t	avr_mutex	/* Type of sync object used on the OS. e.g. HANDLE, OS_EVENT*, ID and etc.. */
