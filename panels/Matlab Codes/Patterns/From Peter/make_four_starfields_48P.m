% make_four_starfields_48P.m designed for panoramic behavioral arena
% 7/21/2013 based on make_six_translating_starfields.m
...
MOTIONDURATION_SEC = 2;
FRAMERATE_FRAMESPERSEC = 80.0;
% arena:
...
allPats(:,:,:,1) = frames;
%%
XVELOCITY_METERSPERSEC = sqrt(2)/2;
YVELOCITY_METERSPERSEC = sqrt(2)/2;
ZVELOCITY_METERSPERSEC = 0;
frames = zeros(NUMVERTPIX, NUMHORIZPIX, numFrames);
...
str = [directory_name '\Pattern_four_starfields_48P'];
save(str, 'pattern');
