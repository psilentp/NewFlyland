...
if exist('myPCCfg.mat','file')
    load([controller_path filesep 'myPCCfg'],'-mat');
else
...
save([controller_path filesep 'myPCCfg'], 'myPCCfg');
...
if exist('SD.mat','file')
    try
        load([controller_path filesep 'SD'])
...
disp(controller_path)
save([controller_path filesep 'SD'], 'SD');
