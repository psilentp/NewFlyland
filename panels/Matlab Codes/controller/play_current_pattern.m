function varargout = play_current_pattern(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @play_current_pattern_OpeningFcn, ...
                   'gui_OutputFcn',  @play_current_pattern_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before play_current_pattern is made visible.
function play_current_pattern_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to play_current_pattern (see VARARGIN)
...
function varargout = play_current_pattern_OutputFcn(hObject, eventdata, handles)
